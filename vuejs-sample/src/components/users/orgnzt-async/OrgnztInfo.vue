<template>
  <div v-if="clickedInfo.orgnztUnitNo === undefined" class="card text-center bg-transparent border-primary text-primary mt-4 mb-4">
    <div class="card-body">
      조직을 선택하세요.
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <b-form-group label="사용여부" horizontal :label-cols="3" label-text-align="right">
              <b-form-select :options="useYnOptions" :disabled="disabled" v-model="clickedInfo.useYn" class="mb-3"></b-form-select>
            </b-form-group>
          </div>
        </div>
      </b-form>
