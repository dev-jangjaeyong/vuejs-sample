<template>
  <div>
    <b-form>
      ...
      <b-form-group label="담당자명" horizontal :label-cols="2" v-if="mode === 'PUT'">
        <b-input type="text" :disabled="true" placeholder="담당자명" v-model="userInfoModalInfo.userName"></b-input>
      </b-form-group>
      <b-form-group label="담당자명" horizontal :label-cols="2" v-else>
      ...
      <b-form-group label="협력업체" horizontal :label-cols="2">
        <b-form-select v-if="userInfoModalInfo.affiliateCode === ''" v-model="affiliateCodeOptions[0].value" :options="affiliateCodeOptions"></b-form-select>
        <b-form-select v-else v-model="userInfoModalInfo.affiliateCode" :options="affiliateCodeOptions"></b-form-select>
        <!--<b-form-select v-model="userInfoModalInfo.affiliateCode === '' ? userInfoModalInfo.affiliateCode=affiliateCodeOptions[0].value : userInfoModalInfo.affiliateCode" :options="affiliateCodeOptions"></b-form-select>-->
      </b-form-group>
      ...
      <b-form-group label="로그인일시" horizontal :label-cols="2" v-if="mode === 'PUT'">
