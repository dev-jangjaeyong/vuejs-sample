    ...
    <b-form>
      <b-card-body class="pb-2 pt-1">
        ...
        <b-form-group>
          ...
          <div class="form-row">
            <div class="col-sm-6">
              <b-form-group label="등급" horizontal :label-cols="2">
            ...
            <div class="col-sm-6">
              <b-form-group label="세부등급" horizontal :label-cols="2">
                <b-input type="text" v-if="modalData.carGradeName !== ''" v-model="modalData.carGradeName" readonly></b-input>
                <b-input type="text" v-else v-model="modalData.carGradeNo"></b-input>
              </b-form-group>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="col-sm-6">
              <b-form-group label="최종렌트료" horizontal :label-cols="2">
                <b-input type="text" v-model="modalData.finalRentalFee" ></b-input>
              </b-form-group>
            </div>

            <div class="col-sm-6">
              <b-form-group label="금리" horizontal :label-cols="2">
                <b-input type="text" v-model="modalData.interestRate" ></b-input>
              </b-form-group>
            </div>
          </div>
        ...
        <div class="form-row">
          <div class="col-sm-6">
            <b-form-group label="잔가율" horizontal :label-cols="2">
              <b-input type="text" v-model="modalData.residualRate" ></b-input>
            </b-form-group>
          </div>

          <div class="col-sm-6">
            <b-form-group label="잔가금액" horizontal :label-cols="2">
              <b-input type="text" v-model="modalData.residualAmt" ></b-input>
            </b-form-group>
          </div>
        </div>

          <div class="form-row" v-if="modalData.brandName !== ''">
            <div class="col-sm-6">
