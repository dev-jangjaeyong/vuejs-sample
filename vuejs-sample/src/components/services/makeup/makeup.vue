<template>
  <div>
    <h4 class="font-weight-bold py-3 mb-4">
      <span class="text-muted font-weight-light">고객서비스 /</span> 메이크업서비스 관리
    </h4>

    <div class="ui-bordered px-4 pt-4 mb-4">
      <div class="form-row align-items-center">
        <div class="col-md mb-4">
          <b-form-group label="제휴사">
    ...
    <b-card>
      <h5 slot="header" class="mb-0">메이크업서비스 목록</h5>
      <div class="row">
        <div class="col">
          <b-form-group>
            Records: &nbsp;
...
export default {
  ...
  data: () => ({
    ...
    fields: [
      ...
      {key: 'affiliateName', sortable: false, tdClass: 'align-middle', label: '제휴업체', 'class': 'text-center'},
  ...
  methods: {
      ...
      if (ctx !== undefined) {
        if (ctx.sortBy !== undefined) {
          switch (ctx.sortBy) {
            ...
            case 'svcReqstUserName': this.searchParameters['order'] = 4; break
    ...
    loadAffiliateCode () {
      const parameter = '?codeLv2=SVC_ITEM_CODE&lv=4&codeLv3=' + this.searchParameters['svcItemCode']
    ...
    openModal (flag) {
      if (flag) {
        // Row 등록 Modal Open
        this.openModalTitle = '메이크업서비스 등록'
        ...
        // Row 수정 Model Open
        this.openModalTitle = '메이크업서비스 상세'
