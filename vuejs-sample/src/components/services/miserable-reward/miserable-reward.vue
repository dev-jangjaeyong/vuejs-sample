<template>
  <div>
    <h4 class="font-weight-bold py-3 mb-4">
      <span class="text-muted font-weight-light">고객서비스 /</span> 헛걸음보상서비스 관리
    </h4>
    ...
    <b-card>
      <h5 slot="header" class="mb-0">헛걸음보상서비스 목록</h5>
      <div class="row">
        <div class="col">
          <b-form-group>
            Records: &nbsp;
...
export default {
  ...
  methods: {
    ...
    openModal (flag) {
      if (flag) {
        // Row 등록 Modal Open
        this.openModalTitle = '헛걸음보상서비스 등록'
        ...
        // Row 수정 Model Open
        this.openModalTitle = '헛걸음보상서비스 상세'
