<template>
  <div>
    <h4 class="font-weight-bold py-3 mb-4">
      <span class="text-muted font-weight-light">통계 /</span> 로그인 현황
    </h4>
    ...
    <b-card>
      <h5 slot="header" class="mb-0">로그인 현황</h5>
...
export default {
  ...
  data: () => ({
    ...
    perPage: 10,
    currentPage: 1,
    perPageOptions: [10, 20, 30, 40, 50, 80, 100, 200],
    isBusy: false,
    state: {
  ...
  created () {
    // this.loadTableData() // notice data load
  },
  methods: {
    // notice data load
    loadTableData (ctx) {
